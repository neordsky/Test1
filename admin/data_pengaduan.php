<div class="container">
	<div class="row">
		<div class="col-md-12 mt-3">
			<div class="card">
				<div class="card-header" style="background-color: #A8AFB5">
					DATA PENGADUAN
				</div>
								...
								<tr>
									...
									<td>
										...
										if ($data['status'] == 'proses') {
											...
											echo "<span class='badge bg-warning'>Tolak</span>";
										} else {
									...
									<td>
										<?php 
										if ($data['status'] != 'selesai' & $data['status'] != 'proses' & $data['status'] != 'tolak' ) { ?>
